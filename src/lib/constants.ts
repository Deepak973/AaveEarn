 ...
 */
export const APP_NAME = 'Earn on Aave';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'supply and earn yield on Aave';
 ...
 */
export const APP_BUTTON_TEXT = 'Earn Aave Yield';
