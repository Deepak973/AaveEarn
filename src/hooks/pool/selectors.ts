...
export const selectReserves = (poolReserve: ReservesDataHumanized) =>
  poolReserve.reservesData;

export const selectUserReservesData = (
  userPoolReserves: UserReservesDataHumanized
) => userPoolReserves.userReserves;
export const selectUserEModeCategory = (
  userPoolReserves: UserReservesDataHumanized
